...
const App = () => (
  <div className="App">
    ...
    <p>CSSModule를 이용한 자동 클래스명 생성 예시</p>
    <ModuleCss></ModuleCss>

    <h2>classnames 예제</h2>
    <p>
      classnames 이용해서, 클래스명의 문자열 연결, 객체의 true/false에 따라서
      조건부 클래스명 적용
    </p>
    <CSSModule></CSSModule>
    ...
    <p>js안에서 css 조건을 주고, props 속성에 따른 컴포넌트 조건부 랜더링</p>
    ...
    >
      <Ex9 name="무선 이어폰" price={30000}></Ex9>

      <Ex9 name="무선 이어폰" price={5000} isDiscounted={true}></Ex9>
      <Ex9 name="무선 이어폰" price={30000}></Ex9>
